...
$(document).ready(function() {
  ...
  //   End of content lovingly stolen from the Google Developer Docs. I have no idea what I have stolen from them, but I know that I need to learn what
  // the heck is going on here.

  // Begin code that Chris Pete actually wrote:
  ...
  $("#searchButton").on("click", function() {
    ...
    if (title != "" && titleFromOMDB != undefined) {
      ...
      var queryURL =
        ...
        titleFromOMDB +
        "%20trailer" +
        "&safeSearch=moderate&type=video&videoDefinition=any&videoType=any&key=AIzaSyAdbJz-qr5qNeHZKT9uV-ulkjw6J8WdppY";
