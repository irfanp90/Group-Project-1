  ...
  .ready(function () {
    ...
    $("#searchButton").on("click", function () {
      ...
      if (title != "" && titleFromOMDB != undefined) {
        ...
        var queryURL = "https://www.googleapis.com/youtube/v3/search?part=snippet&q=" + titleFromOMDB + "%20trailer&safeSearch=moderate&type=video&videoDefinition=any&videoType=any&key=" +
